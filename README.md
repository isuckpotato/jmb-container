# Unofficial Dockerized version of JMusicBot update (Forked from: [Craumix](https://hub.docker.com/r/craumix/jmusicbot) and commits from https://github.com/SeVile/MusicBot, with @MichailiK)
